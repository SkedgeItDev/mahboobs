...
- Face-down tile backs change by level. Art lives in `public/images/tile-backs`. The color set (green, purple, red, black) advances every 10 levels and then cycles; paths and the decade length live in `app/config.ts`.
